    ...
    (set, get) => ({
        ...
        set(
          produce((state: MessageStore) => {
            if (message.type === MessageType.Direct) {
              ...
              state.messages.direct[sender][recipient][message.messageId] =
                message;
      ...
      getMessages: (type, options) => {
        ...
        if (
          ...
          options.myNodeNum !== undefined &&
          options.otherNodeNum !== undefined
        ) {
